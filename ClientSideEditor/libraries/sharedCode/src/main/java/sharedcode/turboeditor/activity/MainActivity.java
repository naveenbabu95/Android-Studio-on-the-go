    ...
    */
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (mDrawerToggle.onOptionsItemSelected(item)) {
            ...
            Intent launchIntent = getPackageManager().getLaunchIntentForPackage("com.manichord.mgit");
...
//mDrawerLayout.setFocusableInTouchMode(false);
   ...
   void aFileWasSelected(GreatUri uri) {
    ...
    public void OpenInfo(View view) {
        Intent launchIntent = getPackageManager().getLaunchIntentForPackage("com.example.pranjall.fm");
        if (launchIntent != null) {
            startActivity(launchIntent);//null pointer check in case package name was not found
        }
