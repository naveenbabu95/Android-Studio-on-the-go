...
public class AboutDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        CharSequence message = Html.fromHtml("Hi. This is the client app to our solution for your Android development woes. This is AS-otg, for now, without git integration.\n" +
                "Do support us with any feedback.\n" +
                "Designed by Avinash Narendra, Naveen Babu and Pranjall Kumar");
